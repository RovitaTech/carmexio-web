...
/**
 * Spanish public URLs; every feature is lazy-loaded. The public site renders
 * inside `Shell` (header, footer, tab bar); `/admin` has its own chrome.
 */
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        // The header floats transparent over the home hero until you scroll.
        data: { overlayHeader: true },
